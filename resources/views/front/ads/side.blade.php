<div class="sidebar">
  ...
  <div class="widget">
    @foreach ($global_side_top_ads as $top)
    <div class="ad-sidebar">
      @if ($top->side_ad_url == '')
      <img src="{{ asset('uploads/'.$top->side_ad) }}" alt="">
      @else
      <a href="{{ $top->side_ad_url }}"><img src="{{ asset('uploads/'.$top->side_ad) }}" alt=""></a>
      @endif
    </div>
    @endforeach
  </div>
  ...
  <div class="widget">
    <div class="live-channel">
      ...
      <div class="live-channel-item">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/V0I5eglJMRI" title="YouTube video player"
          frameborder="0"
      ...
      <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        <li class="nav-item" role="presentation">
          <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home"
            type="button" role="tab" aria-controls="pills-home" aria-selected="true">Recent News</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile"
            type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Popular News</button>
        </li>
      </ul>
  ...
  <div class="widget">
    @foreach ($global_side_bottom_ads as $bottom)
    <div class="ad-sidebar">
      @if ($bottom->side_ad_url == '')
      <img src="{{ asset('uploads/'.$bottom->side_ad) }}" alt="">
      @else
      <a href="{{ $bottom->side_ad_url }}"><img src="{{ asset('uploads/'.$bottom->side_ad) }}" alt=""></a>
      @endif
    </div>
    @endforeach
  </div>
