...
@section('button')
<a href="{{ route('admin_sub_category_create') }}" class="btn btn-primary"><i class="fas fa-plus"></i></a>
@endsection
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="pt_10 pb_10">
                    ...
                    <a href="{{ route('admin_sub_category_delete',$row->id) }}" class="btn btn-danger"
