...
@section('heading', 'Video Gallery')
@section('button')
    <a href="{{ route('admin_video_create') }}" class="btn btn-primary"><i class="fas fa-plus"></i></a>
@endsection
                            ...
                            <table class="table table-bordered" id="example1">
                                ...
                                @foreach($videos as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <iframe style="width: 300px; height: 150px; " width="560" height="315"
